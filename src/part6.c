...
//Our row_slot() function will become cursor_value(), 
//which returns a pointer to the position described by the cursor
...
// We will add a Cursor object which represents a location in the table. 
