...
PrepareResult prepare_insert(InputBuffer* input_buffer, Statement* statement) {
  ...
  */
  ...
  // We will no use scanf because it has some disadvantages. If the string it’s reading 
  // is larger than the buffer it’s reading into, it will cause a buffer overflow and start 
  // writing into unexpected places. We want to check the length of each string before we copy it 
  // into a Row structure. And to do that, we need to divide the input by spaces.
  // We're going to use strtok() to do that.
  ...
  // convert the string (character array) to an integer.
